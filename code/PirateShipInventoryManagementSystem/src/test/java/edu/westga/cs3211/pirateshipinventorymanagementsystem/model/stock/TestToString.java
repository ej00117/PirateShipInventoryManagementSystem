...
class TestToString {
	...
	void testToStringWithSpecialQuality() {
		...
		String text = "Name: mercury, Quantity: 2.0, Condition: PERFECT, Special Qualities: [LIQUID]";
	...
	void testToStringWithoutSpecialQuality() {
		Stock stock = new Stock("mercury", 2.0, Condition.PERFECT, new ArrayList<SpecialQuality>());
		
		String text = "Name: mercury, Quantity: 2.0, Condition: PERFECT, Special Qualities: NONE";
